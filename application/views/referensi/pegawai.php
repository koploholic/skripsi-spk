      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>Profilematching/data_departemen"><i class="fa fa-circle-o"></i> Departemen</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>Profilematching/data_pegawai"><i class="fa fa-circle-o"></i> Pegawai</a></li>
